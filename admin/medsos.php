...
<div class="wrapper">
    ...
    <h2 class="mb-4">Input Link Sosial Media</h2>
    <form action="../Mayawana_Web/index.php" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <select name="platform" class="form-control">
                ...
                <option value="lamar">Link Lamaran</option>
            </select>
        </div>
        <div class="mb-3">
            <label for="link" class="form-label">Link</label>
            <textarea class="form-control" name="link" rows="1" placeholder="Masukkan link"></textarea>
        </div>
